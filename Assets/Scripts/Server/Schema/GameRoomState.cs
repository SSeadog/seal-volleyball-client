...
public GameRoomState() { }
	...
	[Type(5, "number")]
	public float gameEndTime = default(float);

	[Type(6, "number")]
	public float leftTeamScore = default(float);

	[Type(7, "number")]
	public float rightTeamScore = default(float);

	[Type(8, "ref", typeof(VolleyBall))]
	public VolleyBall volleyBall = null;
}
